...
class CountTestCase(unittest.TestCase):
    ...
    def test_count1(self):
        """Test count from an empty bag."""
        bag = ListBag()
        bag.count(2)

    def test_count2(self):
        """Test count an item that isn't in the bag."""
        bag = ListBag([1, 3, 4, 4, 7, 2, 3])
        bag.count(9)

    def test_count3(self):
        """Test count an item that is in the bag."""
        bag = ListBag([1, 3, 4, 4, 7, 2, 3])
        bag.count(3)
...
class EqTestCase(unittest.TestCase):
    ...
    def test_eq1(self):
        """Test equality of two same lists with different order."""
        bag1 = ListBag([1, 3, 5])
        bag2 = ListBag([2, 4, 6])
        bag1 == bag2
